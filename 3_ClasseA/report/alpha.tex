...
Verifica-se que as impedâncias do circuito são $Z_{in}=2570.59\pm78.55 \Omega$, $Z_{01}=1.038\pm0.751 \Omega$ e $Z_{02}=0.664\pm0.009 \Omega$. O limite superior da banda passan-te a $-3dB$ encontra-se em $58kHz$.
...
\begin{table}[h]
    ...
    \hline
    Frequência sinal de entrada (Hz) & Vi(V) & Vo(V)& Log(f) (Hz)& $i_o/i_i (dB)$ \\ \hline
...
\fig[.28]{../img/resposta_frequencia.png}{Resposta em frequência do circuito}
