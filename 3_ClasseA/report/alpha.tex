...
\eq{i_C = \beta_f i_B}
\eq{i_E = \lr{\beta_f +1} i_B}
\eq{i_E = \frac{\beta_f+1}{\beta_f} i_C}
\eq{i_E	= I_{ES} \lr{e^{\frac{v_{BE}}{\eta V_T}}-1}}
...
\eq{-\frac{V_{SS}+V_{BE2}}{R_2} = \frac{\beta_f + 2} i_B = \frac{\beta_f + 2}{\beta_f} I}
