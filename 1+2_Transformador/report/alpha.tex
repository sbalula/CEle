...
Na primeira parte do trabalho determinou-se a relação entre as espiras do transformador utilizado, sendo que se chegou à relação de $\frac{n_{pri}}{n_{sec}}=8,63\pm0,01$. Este valor é fiável uma vez que o resultado obtido através do ajuste linear e através da divisão do número de espiras são compatíveis. Observou-se uma curva de histerese do núcleo do transformador de acordo com o esperado.  
