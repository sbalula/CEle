...
\fig{p_vs_s.pdf}{Ajuste obtido para a relação entre primário e secundário}
Para a relação entre primário e secundário obteve-se $a=\frac{n_{pri}}{n_{sec}}=8.63\pm0.01$.\\
\fig{5_vs_prim.pdf}{Ajuste obtido para a relação entre primário e o enrolamento de 5 espiras}
...
\fig{5_vs_sec.pdf}{Ajuste obtido para a relação entre o secundário e o enrolamento de 5 espiras}
