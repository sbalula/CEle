...
\subsection*{I.3. Ensaio em vazio do transformador}
Neste ponto considerou-se que o erro das grandezas dadas pelo software de aquisição era de $0,5\%$ do valor da grandeza. Os resultados fornecidos pelo software para o estudo do transformador com o secundário em vazio estão representados na tabela 
  ...
  \tabela{Dados recolhidos do software para o estudo do transformador com o secundário em vazio}{c|c|c}{
    ...
    $<v2>(V)$ & $2,989\pm0,015$ & $0,0241\pm0,001$ \\ 
