...
Neste ponto considerou-se que o erro das grandezas dadas pelo software de aquisição era de $0,5\%$ do valor da grandeza. Os resultados fornecidos pelo software para o estudo do transformador com o secundário e primário em vazio estão representados nas tabelas
  \tabela{Dados recolhidos do software para o estudo do transformador com o secundário em vazio}{c|c|c}{
    Posição & a     & b \\
  ...
  \tabela{Dados recolhidos do software para o estudo do transformador com o primário em vazio}{c|c|c}{
    Posição & a     & b \\
...
\subsection*{I.3. Ensaio em vazio do transformador}
Os dados obtidos para o estudo do transformador em vazio encontram-se na tabela

 \tabela{Dados obtidos para o estudo do transformador em vazio}{c|c|c}{
          Casos                    & A   & B \\
  
    $I_{1ef} / I_{2ef} (A)$ & $0,084\pm0,001$ & $0,720\pm0,003$ \\ \hline
    $P_{12}  / P_{21} (W)$ & $0,647\pm0,003$ & $5,205\pm0,026$ \\ \hline
    $P_{10}  / P_{20}(W)$ & $5,455\pm0,027$ & $11,051\pm0,055$ \\ \hline
    $r_{fe}(\Omega)$ & $791,982\pm11,959$ & $86,609\pm1,308$ \\ \hline
    $r_1   / r_2'(\Omega)$ & $-18,813\pm23,556$ & $1500,465\pm25,433$ \\ 
    ...
    $\lambda_{11} /\lambda_{22}'(H)$ & $-0,129\pm8,949$ & $-0,257\pm0,360$ \\ 
}
